	...
	<nav class="navbar navbar-expand-md bg-light">
		...
		<div class="collapse navbar-collapse mt-2 mb-1 ms-1" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link active text-center" aria-current="page" href="Corruption.html">Corruption</a>
				</li>
				<div class='vr d-none d-md-block'></div>
				<li class="nav-item">
					<a class="nav-link active text-center" aria-current="page" href="Social Injustice.html">Social Injustice</a>
				</li>
				<div class='vr d-none d-md-block'></div>
				<li class="nav-item text-center">
				<a class="nav-link active text-center" aria-current="page" href='' id='darkMode'>Dark Mode</a>
				</li>
			</ul>
